---
title: How to Fix Android App Not Installed Error on Vivo G2 Quickly? | Dr.fone
date: 2024-07-19T22:46:27.701Z
updated: 2024-07-20T22:46:27.701Z
tags: 
  - problems
categories:
  - android
description: This article describes How to Fix Android App Not Installed Error on Vivo G2 Quickly?
excerpt: This article describes How to Fix Android App Not Installed Error on Vivo G2 Quickly?
keywords: android guide,android fix,Vivo G2 android repair,android tips,Vivo G2 android fix,android troubleshooting,android solutions,Vivo G2 android help
...
## [8 Quick Fixes] Unfortunately, Snapchat has Stopped on Vivo G2
...
- Can fully repair faults with your Vivo G2’s firmware in a few simple steps.
...
**Step 2**: From the main menu, click the System Repair option, followed by the **Android** option. Of course, if you have an iOS device you want to repair in the future, the option is there if you want it. Also, connect your Vivo G2 to your computer using the USB cable.
...
**Step 5:** Once in Download Mode, the software will now download and install a fresh version of your Vivo G2’s operating system. This can take some time, so make sure your device stays connected, and your computer stays on and doesn’t shut down.
...
**Step 1:** Open the Settings menu on your Vivo G2 and select the About Phone option.
...
**Step 1:** Open the Settings menu on your Vivo G2, followed by the Wi-Fi option.
...
Unfortunately, there’s no easy fix to this, and if you want to continue using the app, you’ll need to reflash your Vivo G2 back to its original firmware, and then wait until the ROM developers update the ROM to be compatible with social apps like Snapchat.
...
2. Connect your Vivo G2 to your Windows computer using the USB cable
...
7. Allow the software to repair your Vivo G2 automatically
...
One of the last resorts you can take is factory resetting your Vivo G2 back to its original settings. From the day you first started using your device, you’ve been using the system and downloading files and apps, and over time this increases the chances of creating a bug.
