---
title: How to Fix It Honor Magic V2 Wont Turn On | Dr.fone
date: 2024-09-12T16:08:56.221Z
updated: 2024-09-19T16:22:41.618Z
tags: 
  - problems
categories:
  - android
description: This article describes How to Fix It Honor Magic V2 Wont Turn On
excerpt: This article describes How to Fix It Honor Magic V2 Wont Turn On
keywords: android solutions,android support,Honor Magic V2 android support,android fix,Honor Magic V2 android repair,Honor Magic V2 android help,android tips
thumbnail: https://thmb.techidaily.com/a1ac37f5d8004b4ebc86b20658724b93ef9aff951f603f30c9c8797a450783bc.jpg
---

## How to Fix It: Honor Magic V2 Won't Turn On

Did your Honor Magic V2 decide to go on vacation and refuses to turn on? If your Honor Magic V2 won’t turn on for no apparent reason, finding why it failed to power on and the solution for it is not a fun process.
...
## Part 1: Common Reasons That Your Honor Magic V2 Won't Turn On

If you cannot find any reason why your Honor Magic V2 will not switch on, here are some possible reasons:
...
3. The operating system or installed software is corrupted. The tell-tale sign if this is that if you manage to switch on your Honor Magic V2, it freezes or crash soon after.
...
If your Honor Magic V2 won’t turn on, here is how you can use the software to recover data:

**Step 1: Launch [Wondershare Dr.Fone](https://tools.techidaily.com/wondershare/drfone/phone-switch/)**

On your desktop computer or laptop, open Wondershare Dr.Fone. Click on Data Recovery on the left column. Connect your Honor Magic V2 to the computer using a USB cable.
...
Look up for your device – pick the Honor Magic V2 device Name and Device Model. Advance by clicking on the Next button.
...
**Step 4: Go into your Honor Magic V2’s Download Mode.**

The data recovery tool will guide you on how you can go into your Honor Magic V2’s Download Mode. You should be getting a step-by-step guide on your computer.
...
Using the provided USB cable, attach your Honor Magic V2 to your computer – the data recovery tool should be able to discover your device automatically and scan it for recoverable data.
...
- This tool is aptly effective for all the latest Honor Magic V2 devices.
...
**Phase 1: Get the Honor Magic V2 device ready and connect it**
...
Step 3: Now, over the Honor Magic V2 device information window, ensure to feed your exact device details. Press the ‘Next’ button then on.

![go to SMS to export text messages](https://images.wondershare.com/drfone/guide/android-system-repair-2.png)

**Phase 2: Enter ‘Download’ mode for fixing your Honor Magic V2**

Step 1: You need to put your Honor Magic V2 in Download mode for resolving the Android phone will not switch on.

- For the Honor Magic V2 device having ‘Home’ button, you got to switch it off and press ‘Volume Down’, ‘Home’, and ‘Power’ keys for 5-10 seconds at once. Let them go and click on the ‘Volume Up’ button to put your phone in ‘Download’ mode.
...
1. For any Android devices, remove the battery (considering the battery of your Honor Magic V2 can be removed) and leave it out for at least 30 minutes. Put back the battery in and try to turn it on.
2. Press and hold down the **Power** and **Volume Down** buttons at the same time for 15-30 minutes to reboot the Honor Magic V2 device.
3. Should the first two steps do not work, charge your Honor Magic V2 to get it out of the start-up loop. You can also opt to use a different battery, just in case your current battery is the source of the problem.
4. If there are any connected hardware e.g. SD card, remove them from the Honor Magic V2 device.
5. Start your Honor Magic V2 in **Safe Mode** by pressing and holding down the **Menu** or **Volume Down** button on your device.
...
7. Send your Honor Magic V2 to the repair shop should none of these steps work.

## Part 5: Useful Tips to Protect Your Honor Magic V2

There are several reasons as to why your Honor Magic V2 won’t turn on. The problem could be a hardware or software issue which could be prevented. Here are some useful tips to protect your Honor Magic V2.

**I. Hardware**

- Remember that the components that make your Honor Magic V2 is sensitive. To protect these components from being damaged, use a good guard casing.
- Take apart your Honor Magic V2 and clean it routinely to avoid dust and lint from clogging the phone and overheating it.
...
- Install reliable anti-virus and anti-malware software to safeguard your Honor Magic V2 from malicious attacks.
...
It is important to note that your phone contains some important data. Therefore, when your Honor Magic V2 won't turn on do not just give up - there are plenty of tools at your disposal to recover back your files and phone.
...
## 6 Fixes to Unfortunately WhatsApp has stopped Error Popups On Honor Magic V2
...
- Can be downloaded for free and repairs the Honor Magic V2 device in few easy steps
...
Insufficient storage could be the other reason why for your WhatsApp has stopped. When your device starts running out of space, some apps may not be able to operate properly for their functions take up space in the Honor Magic V2 device. And probably WhatsApp is one of them. If the space is the case with you, we suggest you the following two things to go with.
...
It is a well-known fact that Android device and Gmail account go hand in hand. To run the Honor Magic V2 device smoothly, it is always asked to enter your Gmail address for further configurations. And when WhatsApp stops on your device, the reason might be your Gmail account. Most probably it is not valid now or maybe hacked. If this is the case, we suggest you to log out and log in with some another Gmail account.
