---
title: How to Exit Android Factory Mode On Poco C50? | Dr.fone
date: 2024-07-19T22:36:14.533Z
updated: 2024-07-20T22:36:14.533Z
tags: 
  - problems
categories:
  - android
description: This article describes How to Exit Android Factory Mode On Poco C50?
excerpt: This article describes How to Exit Android Factory Mode On Poco C50?
keywords: android support,Poco C50 android support,android troubleshooting,Poco C50 android troubleshooting,Poco C50 android problems,Poco C50 android issues,android guide,android solutions,android tips,Poco C50 android repair,Poco C50 android guide
...
## 7 Solutions to Fix Chrome Crashes or Won’t Open on Poco C50

Google Chrome is one of the most popular web browsers in the world. It is fast, secure, and easy to use. However, like any other app, it is not free from errors. Many users have reported that Chrome crashes or won’t open on their Poco C50. If you are also facing this issue, then you have come to the right place. In this article, we will discuss the reasons behind this problem and provide you with 7 solutions to fix Chrome crashes or won’t open on Poco C50.
...
2\. Now simply swipe the app up/left/right (according to the Poco C50 device).
...
Now, you need to connect your Poco C50 with the computer using USB cord. When the Poco C50 device is connected successfully, click on the “Android Repair” option from the left panel.
