---
title: How To Deal With the Honor 90 Screen Black But Still Works? | Dr.fone
date: 2024-07-19T22:24:38.040Z
updated: 2024-07-20T22:24:38.040Z
tags: 
  - problems
categories:
  - android
description: This article describes How To Deal With the Honor 90 Screen Black But Still Works?
excerpt: This article describes How To Deal With the Honor 90 Screen Black But Still Works?
keywords: android tips,android help,android fix,Honor 90 android help,android support,Honor 90 android issues,Honor 90 android repair,Honor 90 fix android problems
...
Authentication error occurs when the “deal” between the Wi-Fi router and device fails due to certain reasons. First, the Honor 90 device sends the password of the network and the "connect" request in an encrypted format to the Wi-Fi router. Then, the router decrypts the password and compares the password saved on it. Now, if the password matches, it sends affirmation for the "connect" request, and then the Honor 90 device is allowed to connect to the network.
...
1. Connect your Honor 90 to the computer, and select "Android Repair" in the middle.
...
1. Next up, you should boot your Honor 90 in download mode by following the on-screen instructions.
...
Step 1: Head to the “Settings” of your Honor 90 and then opt for “Wireless and Networks” followed by “WLAN/WiFi”.

Step 2: Now, hit on the WiFi network that is showing "authentication error occurred".

Step 3: Depending on your Honor 90 model, look for “IP Settings” and tap on it. Now, switch the “DHCP” to “Static”.
...
There are instances where an outdated OS version of your Honor 90 may create a hindrance in establishing a connection between your device and the WiFi network. You need to update your Android firmware to the latest version and then check if the problem persists or not.

Step 1: Launch “Settings” of your Honor 90 and then get into the “About Phone” option.
