---
title: How to Fix Android.Process.Media Has Stopped on Xiaomi Redmi 12 | Dr.fone
date: 2024-06-09T07:48:11.860Z
updated: 2024-06-10T07:48:11.860Z
tags: 
  - problems
categories:
  - android
description: This article describes How to Fix Android.Process.Media Has Stopped on Xiaomi Redmi 12
excerpt: This article describes How to Fix Android.Process.Media Has Stopped on Xiaomi Redmi 12
keywords: Xiaomi Redmi 12 android tips,Xiaomi Redmi 12 android fix,android problems,android guide,android tips,android fix,android support,android repair,fix android problems,Xiaomi Redmi 12 android issues,android solutions
thumbnail: https://thmb.techidaily.com/1e90b427765970b2a66b4df52c7b1587d47d7c547c6bb5f5df0fa9181f11e1b7.jpg
---

## How to Fix Android.Process.Media Has Stopped on Xiaomi Redmi 12
...
Then connect your Xiaomi Redmi 12 to the computer and make sure that it can be recognized by your computer. Then click on "My Backup" on Dr.Fone.
...
With a full backup of your Xiaomi Redmi 12, you can now embark on a mission to fix the error. There are several methods to clear this error. We have outlined three of the most effective solutions here.
...
Step 6: Turn off the Xiaomi Redmi 12 device and then turn it back on. Go to the Google Services framework again and turn it on to see if the issue has been resolved.
...
Then connect your Xiaomi Redmi 12 with the correct cable and choose "Android" > click "Start".
...
In the Xiaomi Redmi 12 device information interface, remember to select the correct information. Then confirm the warning and click "Next".
...
**Step 2. Repair your Xiaomi Redmi 12 in Download mode.**

Read and follow the [guide here](https://drfone.wondershare.com/guide/android-repair.html) to boot your Xiaomi Redmi 12 in Download mode.
...
If the above steps fail, you might need to perform a factory reset. A factory reset restores the Xiaomi Redmi 12 device to its initial state, which can eliminate many problems, but it will also erase all data. Ensure you back up your important data before proceeding.
...
## Android Safe Mode - How to Turn off Safe Mode on Xiaomi Redmi 12?
...
**Method 1: Restarting the Xiaomi Redmi 12 device**

This is the easiest method to turn off the safe mode in Android. To use this method, follow the steps below.

Step 1 – Tap and hold the power button of your Xiaomi Redmi 12.

Step 2 – You could find the option “Restart”. Tap on it. (If you have only one option, move to the step no 2)

Step 3 – Now, your phone will boot up in some time and you can see the Xiaomi Redmi 12 device is no more on safe mode.

![the Xiaomi Redmi 12 device](https://images.wondershare.com/drfone/article/2017/06/14986725432763.jpg)
...
This time you can see your phone is no more in safe mode. Also, your junk files have been also removed. If you still find the Xiaomi Redmi 12 device is the safe mode, follow the next method.
...
Step 1 – Take the back cover off from the Xiaomi Redmi 12 device and remove the battery. (Not all devices will give you this facility)

Step 2 – Take out the SIM card.

Step 3 – Reinsert the SIM card and insert the battery again.

Step 4 – Turn the Xiaomi Redmi 12 device on by tapping and holding the power button.

Now, you can see your device is out of safe mode. If you still find your device in Safe mode, see the next method.

**Method 4: Wipe the cache of the Xiaomi Redmi 12 device.**

The cache of the Xiaomi Redmi 12 device sometimes creates an obstacle in overcoming the safe mode on Android. To solve this issue, follow the steps below.
...
Before this, remember to take a backup of your Xiaomi Redmi 12. We recommend you to use the Dr.Fone - Phone Backup (Android). This tool is the best in its class to provide users with a very easy-to-use user interface yet powerful solution.
...
If you are using Android version 4.2 or earlier, turn off the Xiaomi Redmi 12 device and turn it on the back by tapping the power button. When the logo appears, tap and hold the volume down button. This will allow the Xiaomi Redmi 12 device to boot in safe mode.
...
**1\. Why is My Xiaomi Redmi 12 on safe mode?**
...
**2\. Safe mode won't turn off on My Xiaomi Redmi 12**
